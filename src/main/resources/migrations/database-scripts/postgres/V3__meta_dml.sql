...
DELETE FROM meta.ui_elements_config WHERE client_id = 1 AND module_name = 'WORKBENCH' AND group_key = 'LINEAGE_METADATA_GRID' AND node_code = 'GLOBAL';

INSERT INTO meta.ui_elements_config (element_id, client_id, module_name, node_code, group_key, parent_id, element_key, translation_key, element_type, layout_type, order_index, is_required, config_json, dynamic_query, query_params, is_active, created_at, created_by, updated_at, updated_by ) VALUES
    (1219, 1, 'WORKBENCH', 'GLOBAL', 'MDRM_METADATA_GRID', NULL, 'table', 'mdrm_metadata_grid_key', 'GRID', 'INLINE', 1, TRUE, '{"gridConfig":{"gridId":"mdrm_metadata","title":"Metadata","rowIdKey":"attribute_name","features":{"enableRowSelection":false,"enableGlobalSearch":true,"enableExport":true},"columns":[{"field":"mdrm","headerName":"MDRM","dataType":"STRING","cellDataType":"text","sortable":true,"filter":"agTextColumnFilter"},{"field":"rules","headerName":"Rules","dataType":"STRING","cellDataType":"text","sortable":true,"filter":"agTextColumnFilter"},{"field":"asset_class","headerName":"Asset Class","dataType":"STRING","cellDataType":"text","sortable":true,"filter":"agTextColumnFilter"},{"field":"attribute_name","headerName":"Attribute Name","dataType":"STRING","cellDataType":"text","sortable":true,"filter":"agTextColumnFilter","flex":1},{"field":"critical_element","headerName":"Critical Element","dataType":"STRING","cellDataType":"text","sortable":true,"filter":"agTextColumnFilter"}]}}', NULL, NULL, TRUE, now(), 'admin', now(), 'admin');

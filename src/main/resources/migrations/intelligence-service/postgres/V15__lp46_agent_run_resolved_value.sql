-- ============================================================================
-- Migration: V20260916_12__lp46_agent_run_resolved_value.sql
-- Also recorded as: V20260821_01__uc10_resolved_value_provenance.sql
...
CREATE TABLE IF NOT EXISTS intelligence.agent_run_resolved_value (
    ...
    -- Basis check constraint
    CONSTRAINT chk_res_basis CHECK (
        resolution_basis IN ('GOVERNED', 'HEURISTIC', 'ASSUMED', 'NONE')
    ),

    -- Constraint 1: Governed value requires domain_version and effective_from
